...
<body>
	...
	//query_name
	$women_dress_in = mysqli_query($S, "SELECT * FROM WS LIMIT  8 OFFSET 2") or 
	...
	//print query_name result
		...
		while ( $row = mysqli_fetch_array ($women_dress_in, MYSQLI_ASSOC) )
		{
			echo "<tr>";
	...
	$women_dress_cm = mysqli_query($S,"SELECT * FROM WS LIMIT  8 OFFSET 2") or 
                                 die( mysqli_connect_error()); 
	//print query_name result
		echo "<table>
			<tr>
