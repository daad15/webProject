...
<body>
	...
	$Plus_WOMEN_pants_in = mysqli_query($S,"SELECT * FROM WS LIMIT 4 OFFSET 10") or 
	...
	$Plus_WOMEN_pants_cm = mysqli_query($S,"SELECT * FROM WS LIMIT 4 OFFSET 10") or 
                                 die( mysqli_connect_error()); 
	//print query_name result
		echo "<table>
			<tr>
